...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if(convertView == null){
          ...
          holder.holeLabel = (EditText) convertView.findViewById(R.id.holeLabel);
          holder.strokeCount = (EditText) convertView.findViewById(R.id.strokeCount);
